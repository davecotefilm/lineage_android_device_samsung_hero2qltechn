...
/**
 * Custom Qualcomm RIL for S7 Edge
 *
 * {@hide}
 */
public class S7edgeRIL extends RIL implements CommandsInterface {

    public S7edgeRIL(Context context, int preferredNetworkType, int cdmaSubscription) {
        this(context, preferredNetworkType, cdmaSubscription, null);
    }

    public S7edgeRIL(Context context, int preferredNetworkType,
